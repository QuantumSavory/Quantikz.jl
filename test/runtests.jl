...
@test circuit2string([CNOT(3,2),CNOT(1,4)]) == circuit2string([CNOT(3,2),CNOT(1,4)], mode=:expanded) == "\\begin{quantikz}[row sep={0.8cm,between origins}]\n\\qw & \\qw & \\ctrl{0} & \\qw\\\\\n\\qw & \\targ{}\\vqw{0} & \\qw & \\qw\\\\\n\\qw & \\ctrl{-1} & \\qw & \\qw\\\\\n\\qw & \\qw & \\targ{}\\vqw{-3} & \\qw\n\\end{quantikz}"
@test circuit2string([CNOT(1,4),CNOT(3,2)]) == circuit2string([CNOT(1,4),CNOT(3,2)], mode=:expanded) == "\\begin{quantikz}[row sep={0.8cm,between origins}]\n\\qw & \\ctrl{0} & \\qw & \\qw\\\\\n\\qw & \\qw & \\targ{}\\vqw{0} & \\qw\\\\\n\\qw & \\qw & \\ctrl{-1} & \\qw\\\\\n\\qw & \\targ{}\\vqw{-3} & \\qw & \\qw\n\\end{quantikz}"
end

@testset "NoiseAll on just qubits" begin
@test circuit2string([NoiseAll(), Measurement(1,2)]) == "\\begin{quantikz}[row sep={0.8cm,between origins}]\n\\qw & \\gate[1,style={starburst,starburst points=7,inner xsep=-2pt,inner ysep=-2pt,scale=0.5}]{} & \\meterD{} & \\\\\n\\cw & \\cw & \\cw & \\cw\\\\\n\\cw & \\cw & \\cwbend{-2} & \\cw\n\\end{quantikz}"
end

@testset "Clearance for vertical classical wires" begin
@test circuit2string([Measurement(2),Measurement(1,1)]) == circuit2string([Measurement(2),Measurement(1,1)], mode=:expanded) == "\\begin{quantikz}[row sep={0.8cm,between origins}]\n\\qw & \\qw & \\meterD{} & \\\\\n\\qw & \\meterD{} &  & \\\\\n\\cw & \\cw & \\cwbend{-2} & \\cw\n\\end{quantikz}"
end
